...
import cashilLogo from "/public/assets/cashilLogo.png"; // pastikan path benar

export default function Landing({ onLogin, onRegister }) {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-blue-100/70 via-white to-white relative overflow-hidden">

      {/* Aksen background: lingkaran gradasi blur di belakang logo */}
